...
export default function ProjectTable({ projects, onEdit, onDelete, onAddProject }) {
  ...
  return (
    <section className="workspace" aria-label="Proje listesi">
      <header className="workspace__intro">
        <div className="workspace__intro-text">
          <h2 className="workspace__title">Proje listesi</h2>
          <p className="workspace__lead">
            Ücret, mesai ve durumu filtreleyerek görüntüleyin.
          </p>
        </div>
        <p className="workspace__count tabular-nums">
          <span className="workspace__count-value">{filtered.length}</span>
